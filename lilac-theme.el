...
(custom-theme-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "#D6B541"))))
 '(font-lock-constant-face ((((class color) (min-colors 89)) (:foreground "turquoise"))))
 '(font-lock-function-name-face ((((class color) (min-colors 89)) (:foreground "#045623"))))
 '(font-lock-keyword-face ((t (:foreground "#DCCFC4"))))
 '(font-lock-string-face ((t (:foreground "firebrick4"))))
 '(font-lock-type-face ((((class color) (min-colors 89)) (:foreground "aquamarine"))))
 '(font-lock-variable-name-face ((((class color) (min-colors 89)) (:foreground "black"))))
 ...
 '(default ((t (:background "#A2739B" :foreground "black")))))
